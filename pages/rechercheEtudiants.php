...
<body>
    ...
    <div class="container-fluid marge text-center">
        <div class="row text-center">
            <div class="col-12">
                <h1 class="titre">Rechercher un Etudiant</h1>
            </div>
        </div>
        <form class="form-inline col-12 offset-md-2 col-md-8" action="afficheRechEtudiant.php" method="GET">
            <div class="input-group mb-3 col-12 col-md-12">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-search"></i></span>
                </div>
                <input class="form-control mr-sm-3" name="recherche" type="search" placeholder="Rechercher un Etudiant suivant n'importe quel critere">
